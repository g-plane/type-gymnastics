...
type Tests = [
  ...
  Expect<Equal<VoidElementExample, [{
    name: 'br',
    attributes: [],
    children: [],
  }]>>,
  Expect<Equal<InvalidVoidElementExample, never>>,
  Expect<Equal<UnquotedAttributeExample, [{
    name: 'div',
    attributes: [{ name: 'id', value: 'main' }],
    children: [],
  }]>>,
  Expect<Equal<SingleQuoteAttributeExample, [{
    name: 'div',
    attributes: [{ name: 'id', value: 'main' }],
    children: [],
  }]>>,
  Expect<Equal<DoubleQuoteAttributeExample, [{
    name: 'div',
    attributes: [{ name: 'id', value: 'main' }],
    children: [],
  }]>>,
  Expect<Equal<SelfCloseTag, [{
    name: 'div',
    attributes: [{ name: 'class', value: 'e' }],
    children: [],
  }]>>,
  Expect<Equal<NumericTagName, [{
    name: '2',
    attributes: [{ name: 'a', value: 'b' }],
    children: [],
  }]>>,
  Expect<Equal<PureText, ['custom text']>>,
  Expect<Equal<MultiTags, [
    {
      name: 'h1',
